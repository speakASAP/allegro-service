...
kubectl set image "deployment/${SERVICE_NAME}" app="$SERVICE_IMAGE_LATEST" -n "$NAMESPACE"
kubectl set image "deployment/${API_GATEWAY_NAME}" app="$API_GATEWAY_IMAGE_LATEST" -n "$NAMESPACE"
kubectl set image "deployment/${FRONTEND_NAME}" app="$FRONTEND_IMAGE_LATEST" -n "$NAMESPACE"
deploy_timing_phase_end "Set deployment images"

deploy_timing_phase_start "Rollout restart"
kubectl rollout restart deployment/"$SERVICE_NAME" -n "$NAMESPACE"
kubectl rollout restart deployment/"$API_GATEWAY_NAME" -n "$NAMESPACE"
kubectl rollout restart deployment/"$FRONTEND_NAME" -n "$NAMESPACE"
